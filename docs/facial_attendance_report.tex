...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.72\textwidth]{images/embedding_space.png}
    \caption{128-Dimensional Hypersphere metric matching with distance threshold boundary ($\theta = 0.60$).}
